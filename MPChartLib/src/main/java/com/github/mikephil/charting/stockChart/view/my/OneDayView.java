...
public class OneDayView extends BaseView {
    ...
    public void initChart(boolean landscape) {
        ...
        lineChart.setNoDataText(getResources().getString(R.string.loadings));
        ...
        //主图左Y轴
        YAxis axisLeftLine = lineChart.getAxisLeft();
        axisLeftLine.setEnabled(false);
...
//        });
        ...
        axisRightLine.setValueLineInside(false);
