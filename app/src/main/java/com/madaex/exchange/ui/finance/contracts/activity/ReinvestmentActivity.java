...
/**
 * 项目：  sun
 * 类名：  ReinvestmentActivity.java
 * 时间：  2020/6/16 14:32
 * 描述：
 */
public class ReinvestmentActivity extends BaseNetActivity<ContractPresenter> implements ContractContract.View {
            ...
            case R.id.submit:
                if (AppUtils.isFastClick2()) {
                    if (Double.valueOf(mNumber.getText().toString().trim()) == 0) {
                        ...
                        params.put("act", "TradeRelease.reinvest");
