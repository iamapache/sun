    ...
    private void init(AttributeSet attrs) {
        ...
        if (typedArray != null) {
            try {
                ...
                mBackgroundColor = typedArray.getColor(R.styleable.DepthMapView_background_color, ResourceUtil.getColor(getContext(), R.color.transparent));
                ...
                mTextPaint.setTextSize(typedArray.getDimension(R.styleable.DepthMapView_text_size, ResourceUtil.getDimension(getContext(), R.dimen.d_12dp)));
...
//                    mIsLongPress = true;
    ...
    private void drawSelectorView(Canvas canvas, int position) {
        ...
        String volume = getContext().getString(R.string.Entrustamount) + ": " + getVolumeValue(mMapX.get(position).getVolume());
        String price = getContext().getString(R.string.entrastPrice) + ": " + getValue(mMapX.get(position).getPrice());
        ...
        canvas.drawText(getContext().getString(R.string.Entrustamount) + ": ",
                mDrawWidth - width / 2 + padding + mTextPaint.measureText(getContext().getString(R.string.Entrustamount)), textHeight + 2, mTextPaint);
        canvas.drawText(getVolumeValue(mMapX.get(position).getVolume()), mDrawWidth + width / 2 + padding, textHeight + 2, mTextPaint);
        canvas.drawText(getContext().getString(R.string.entrastPrice) + ": ",
                mDrawWidth - width / 2 + padding + mTextPaint.measureText(getContext().getString(R.string.entrastPrice)), textHeight * 2 + padding, mTextPaint);
