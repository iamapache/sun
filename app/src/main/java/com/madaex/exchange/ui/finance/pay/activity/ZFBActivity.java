 ...
 * 描述：  ${TODO}
 */
public class ZFBActivity extends BaseNetActivity<WayPresenter> implements WayContract.View {
    ...
    protected int getLayoutId() {
        return R.layout.activity_zfbway;
    }
    ...
    protected void initView() {
        ...
        SpannableString spanStrClick = new SpannableString(getString(R.string.Alipaygenerationexample));
        spanStrClick.setSpan(new ClickableSpan() {
            @Override
            public void onClick(View widget) {
                Intent intent2 = new Intent(mContext, LinkWebViewActivity.class);
                intent2.putExtra(LinkWebViewActivity.WEB_TITLE, getString(R.string.Alipaygenerationexample));
...
//				ds.bgColor = Color.parseColor("#FF0000");
    ...
    protected void initDatas() {
        if (getIntent().hasExtra("bean")) {
            ...
            mEtZfb.setText(dataBean.getAccount());
            ...
            mImg.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(ZFBActivity.this, PhotoSelectorActivity.class);
    ...
    private void validate(boolean b) {
        if (TextUtils.isEmpty(mEtZfb.getText().toString())) {
            ToastUtils.showToast(getString(R.string.alipayaccount));
            return;
        }
