package com.madaex.exchange.ui.market.view;
...
public class KeyboardUtil {
    ...
    public KeyboardUtil(Activity activity, MyKeyBoardView mKeyboardView, int type) {
        this(activity, mKeyboardView, false, type);
    }

    public KeyboardUtil(Activity activity, MyKeyBoardView mKeyboardView, boolean ifRandom, int type) {
        this.mActivity = activity;
        this.mIfRandom = ifRandom;
        this.mKeyboardView = mKeyboardView;
        mKeyboardView.setType(type);
...
//                hideKeyboard();
                if (mOnRetClick != null) {
                    mOnRetClick.onRetClick();
                }

            }  else if (primaryCode == -15) {
//                hideKeyboard();
                if (mOnTWOClick != null) {
                    mOnTWOClick.onOneClick();
                }

            }else if (primaryCode == -16) {
//                hideKeyboard();
                if (mOnTWOClick != null) {
                    mOnTWOClick.onTWOClick();
                }
    ...
    public OnRetClick mOnRetClick;
    public onTWOClick mOnTWOClick;

    public onTWOClick getOnTWOClick() {
        return mOnTWOClick;
    }
    ...
    public OnRetClick getOnRetClick() {
        return mOnRetClick;
    }

    public void setOnRetClick(OnRetClick onRetClick) {
        mOnRetClick = onRetClick;
    }
