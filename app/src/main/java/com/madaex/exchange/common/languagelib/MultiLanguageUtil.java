package com.madaex.exchange.common.languagelib;
...
public class MultiLanguageUtil {
    ...
    private Locale getLanguageLocale() {
        ...
        int languageType = SPUtils.getInt(MultiLanguageUtil.SAVE_LANGUAGE, 0);
    ...
    public void updateLanguage(int languageType) {
        SPUtils.putInt(MultiLanguageUtil.SAVE_LANGUAGE, languageType);
