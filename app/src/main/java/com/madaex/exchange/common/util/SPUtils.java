...
public class SPUtils {
    ...
    private SPUtils(@NonNull Context context, String userId) {
        if (sharedPreferences == null) {
            sharedPreferences = context.getApplicationContext().getSharedPreferences(
     ...
     */
    public static SPUtils init(@NonNull Context context, String userId) {
        if (prefsInstance == null) {
            prefsInstance = new SPUtils(context,userId);
        }
